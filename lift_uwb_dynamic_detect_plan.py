...
class UWBLiftAnimationPlan1:
    def __init__(self):
        ...
        # 添加滑块
        self.slider_ax = self.fig.add_axes([0.25, 0.01, 0.50, 0.03], facecolor='lightgoldenrodyellow')
        self.radius_slider = Slider(self.slider_ax, 'Radius', 0.1, 5.0, valinit=self.radius)
