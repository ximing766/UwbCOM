...
class UwbReaderAssistant:
    ...
    def create_widgets(self):
        ...
        self.baudrate_var = tk.IntVar(self.master, 230400)  # 默认波特率9600
        self.baudrate_var1 = tk.IntVar(self.master, 230400)  # 默认波特率9600
        ...
        info_label = customtkinter.CTkLabel(self.EnterTab.tab("COM"), text="深圳通仅授权小米内部使用...", font=("Roboto", 16), text_color="red")#,image=self.logo, compound="left")
